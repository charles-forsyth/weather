...
def get_moon_phase():
    ...
    if phase_decimal < 0.03 or phase_decimal > 0.97: return "New Moon", "🌑"
    if phase_decimal < 0.22: return "Waxing Crescent", "🌒"
    if phase_decimal < 0.28: return "First Quarter", "🌓"
    if phase_decimal < 0.47: return "Waxing Gibbous", "🌔"
    if phase_decimal < 0.53: return "Full Moon", "🌕"
    if phase_decimal < 0.72: return "Waning Gibbous", "🌖"
    if phase_decimal < 0.78: return "Third Quarter", "🌗"
...
class WeatherApp(tk.Tk):
    ...
    def load_icons(self):
        self.icons = {}
        icon_files = {"temp": "temp.png", "humidity": "humidity.png", "wind": "wind.png", "sky": "sky.png", "hazard": "hazard.png", "pressure": "pressure.png"}
    ...
    def create_widgets(self):
        ...
        tk.Label(self.fore_frame, textvariable=self.moon_phase_var, font=self.normal_font, bg=COLOR_BG, fg=COLOR_FG).grid(row=3, column=0, sticky="w")
    ...
    def update_weather(self):
        ...
        if not data:
            ...
            self.moon_phase_var.set(f"Moon Phase: {moon_name} {moon_emoji}")
